hundreds = input("Enter the amount of $100 dollar bills: ")
fifties = input("Enter the amount of $50 dollar bills ")
twenties = input("Enter the amount of $20 dollar bills: ")
tens = input("Enter the amount of $10 dollar bills: ")
fives = input("Enter the amount of $5 dollar bills: ")
ones = input("Enter the amount of $1 dollar bills: ")
